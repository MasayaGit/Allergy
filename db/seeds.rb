...
Restaurant.create(r_name:"餃子の金将", address:"大阪府大阪市東淀川区瑞光2-397-14", genre:"中華料理")
Restaurant.create(r_name:"スシハイ", address:"大阪府八尾市沼1-361-15", genre:"寿司")
...
Menu.create(m_name:"えびの天ぷら", price:100, allergy:"小麦,甲殻類", restaurant_id:1)
...
Menu.create(m_name:"パンケーキ", price:450, allergy:"小麦,卵,乳", restaurant_id:4)
...
Menu.create(m_name:"たこの唐揚げ", price:300, allergy:"小麦,卵,乳", restaurant_id:6)
Menu.create(m_name:"しょうゆ", price:0, allergy:"小麦", restaurant_id:6)
Menu.create(m_name:"豚玉", price:600, allergy:"小麦,卵,乳", restaurant_id:7)
Menu.create(m_name:"もんじゃ焼き", price:450, allergy:"小麦", restaurant_id:7)
Menu.create(m_name:"豚トロ", price:500, allergy:"卵", restaurant_id:7)
Menu.create(m_name:"かにクリームパスタ", price:950, allergy:"小麦,乳,甲殻類", restaurant_id:8)
Menu.create(m_name:"マルゲリータ", price:600, allergy:"小麦,乳", restaurant_id:8)
Menu.create(m_name:"ティラミス", price:300, allergy:"小麦,卵,乳", restaurant_id:8)
Menu.create(m_name:"むね肉(たれ)", price:110, allergy:"小麦", restaurant_id:9)
Menu.create(m_name:"チキン南蛮", price:300, allergy:"小麦,卵,乳", restaurant_id:9)
